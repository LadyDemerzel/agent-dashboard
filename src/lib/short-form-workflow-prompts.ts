...
const DEFAULT_SHORT_FORM_WORKFLOW_PROMPTS: ShortFormWorkflowPrompts = {
  ...
  videoGenerate: [
    ...
    "Use the updated xml-scene-video defaults explicitly: full-video Qwen3-TTS narration, transcript-driven Qwen3-ForcedAligner-0.6B timing against the known full script, and the pre-rendered music file selected for this project from the saved music library.",
    "Music must come from the saved music library file at the project's selected `generatedAudioRelativePath`. Do not invoke ACE-Step or any other music generator from this workflow -- music is selected and pre-rendered in Settings, not generated per render.",
    ...
    "Save a markdown review document to: {{videoDocPath}} with YAML front matter including status: needs review and notes about what was generated. Mention that the default path used Qwen narration from the XML <script> plus the saved music library track for this project.",
    "Execution contract:",
  ...
  videoRevise: [
    ...
    "Working directory for generated intermediates: {{videoWorkDir}}",
    "Save the playable video to: {{finalVideoPath}}",
    "Save a markdown review document to: {{videoDocPath}} with YAML front matter including status: needs review and notes about what was generated. Mention that the revision stayed on the Qwen-from-<script> + saved-music-library path.",
    "Execution contract:",
    "- This is an artifact-writing task for the Final Video stage.",
